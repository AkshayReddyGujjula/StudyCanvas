...
from routes import upload, query, quiz, page_quiz, flashcards, ocr, transcription, quiz_followup, convert, code_assist, page_title
...
app.include_router(page_title.router, prefix="/api")
